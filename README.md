...
- تقارن الحاضنة المختلطة C+Baa خرج lexer ببصمات مستقرة قبل استبدال المسار الإنتاجي.
- لن يُحذف lexer المكتوب بـ C إلا بعد أن يصبح مسار باء هو المسار الإنتاجي ويمر عبر بوابات QA الكاملة.
