...
![الإصدار](https://img.shields.io/badge/%D8%A7%D9%84%D8%A5%D8%B5%D8%AF%D8%A7%D8%B1-0.3.9-blue.svg)
...
- `v0.3.9` — **Advanced Arrays & String Operations** قيد التنفيذ (نُقلت المهام المنجزة الخاصة بالمصفوفات إلى هذا الإصدار)
...
| **النصوص والمحارف** | ثوابت السلاسل النصية (`"..."`) وثوابت المحارف (`'...'`) + نوع `حرف` UTF-8 |
