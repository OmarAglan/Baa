...
| **تشخيص عربي موجّه (v0.5.4+)** | نطاقات مؤشر أدق تمتد لعدة أسطر عند الحاجة، وأسطر `مساعدة:` عربية للأخطاء الشائعة، ورموز ثابتة مثل `[B1000]`، واختبارات سلبية تقيس التشخيصات المتتالية |
