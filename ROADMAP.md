...
- [ ] **Default lexer flip** — make the Baa-backed wrapper the default compiler path only after full/release QA and focused negative diagnostics pass under the opt-in bridge.
