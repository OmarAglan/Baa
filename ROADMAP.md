...
- [x] **Production Baa-backed lexer wrapper** — the existing parser-facing lexer API routes through the Baa scanner while preserving token heap ownership, source/include buffers, dependency arrays, diagnostics, BOM handling, and cleanup behavior.
