...
> **Version:** 0.9.1.5 | [← Compiler Internals](INTERNALS.md) | [IR Specification →](BAA_IR_SPECIFICATION.md)
...
typedef enum {
    ...
    TOKEN_KEYWORD_FLOAT32, // عشري٣٢ (alias إلى TYPE_FLOAT في v0.4.2)
