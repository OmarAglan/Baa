...
> **Version:** 0.3.4 | [← Compiler Internals](INTERNALS.md) | [IR Specification →](BAA_IR_SPECIFICATION.md)
...
2. Emits `.data` section with global variables and initializers (including fixed-size `صحيح` global arrays with partial init + zero-fill)
