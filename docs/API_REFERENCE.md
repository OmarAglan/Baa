...
> **Version:** 0.4.1.0 | [← Compiler Internals](INTERNALS.md) | [IR Specification →](BAA_IR_SPECIFICATION.md)
...
- Builtin module calls (`v0.4.1`) in `NODE_CALL_EXPR`:
  - Math: `جذر_تربيعي`, `أس`, `مطلق`, `عشوائي`
