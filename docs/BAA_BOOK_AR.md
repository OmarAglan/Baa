...
> **الإصدار:** 0.3.5.5 | [← دليل المستخدم](USER_GUIDE.md) | [مواصفة اللغة →](LANGUAGE.md)
...
- [كتاب باء (Baa): لغة نظم عربية — دليل تعلّم ومرجع](#كتاب-باء-baa-لغة-نظم-عربية--دليل-تعلّم-ومرجع)
  ...
  - [5. الأنواع والمتغيرات والثوابت](#5-الأنواع-والمتغيرات-والثوابت)
    - [5.1. الأنواع الأساسية (v0.3.5.5)](#51-الأنواع-الأساسية-v0355)
    ...
    - [5.5. أحجام الأعداد الصحيحة (v0.3.5.5)](#55-أحجام-الأعداد-الصحيحة-v0355)
  ...
  - [14. التشخيص: الأخطاء والتحذيرات](#14-التشخيص-الأخطاء-والتحذيرات)
...
- دليلًا تعليميًا يبدأ من الأساسيات إلى الميزات المتقدمة ضمن نطاق **v0.3.5.5**
...
### 5.5. أحجام الأعداد الصحيحة (v0.3.5.5)
...
- التحقق من صحة الأمثلة عبر تجميعها على v0.3.5.5
