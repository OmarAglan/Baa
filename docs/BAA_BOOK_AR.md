...
> **الإصدار:** 0.3.4.5 | [← دليل المستخدم](USER_GUIDE.md) | [مواصفة اللغة →](LANGUAGE.md)
...
- [كتاب باء (Baa): لغة نظم عربية — دليل تعلّم ومرجع](#كتاب-باء-baa-لغة-نظم-عربية--دليل-تعلّم-ومرجع)
  ...
  - [5. الأنواع والمتغيرات والثوابت](#5-الأنواع-والمتغيرات-والثوابت)
    ...
    - [5.5. أحجام الأعداد الصحيحة (v0.3.5)](#55-أحجام-الأعداد-الصحيحة-v035)
...
� إلى الاستدعاء التكراري (Recursion) لأن عمق الاستدعاء قد يؤدي إلى تجاوز المكدس.
