...
> **Version:** 0.6.0 | [← Language Spec](LANGUAGE.md) | [API Reference →](API_REFERENCE.md)
...
| `--diagnostics=json` | **JSON Diagnostics** | stdout | Emits machine-readable diagnostics with stable codes, severity/category, source span, and hints. |
...
Note (v0.6.1): text diagnostic headers include a category label derived from the
