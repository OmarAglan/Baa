...
- يمكن تفعيل فحوص وقت التشغيل الاختيارية عبر `-fruntime-checks`: فحوص حدود للفهرسة غير الثابتة، وفحوص مؤشر فارغ قبل فك الإشارة، وفحوص قسمة/باقي قسمة على صفر، وفحوص عدد الإزاحة حيث يستطيع الخافض إصدارها.
