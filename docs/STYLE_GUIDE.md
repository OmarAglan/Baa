...
> **Version:** 0.5.7 | **Last Updated:** 2026-05-22
...
The current version is **0.5.7**. All documents must display this version in their header.
...
- [ ] Version number is 0.5.7 in header
