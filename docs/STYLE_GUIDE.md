...
> **Version:** 0.3.2.9.4 | **Last Updated:** 2026-02-18
...
The current version is **0.3.2.9.4**. All documents must display this version in their header.
...
- [ ] Version number is 0.3.2.9.4 in header
