...
> **Version:** 0.3.12.0 | **Last Updated:** 2026-03-02
...
The current version is **0.3.12.0**. All documents must display this version in their header.
...
- [ ] Version number is 0.3.12.0 in header
