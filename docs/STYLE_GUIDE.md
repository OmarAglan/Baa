...
> **Version:** 0.9.0.1 | **Last Updated:** 2026-05-22
...
The current version is **0.9.0.1**. All documents must display this version in their header.
...
- [ ] Version number is 0.9.0.1 in header
