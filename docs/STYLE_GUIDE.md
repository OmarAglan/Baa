...
> **Version:** 0.9.1.4.5 | **Last Updated:** 2026-05-29
...
The current version is **0.9.1.4.5**. All documents must display this version in their header.
...
- [ ] Version number is 0.9.1.4.5 in header
