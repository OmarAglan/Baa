...
> **Version:** 0.3.2.8.6 | **Last Updated:** 2026-02-17
...
The current version is **0.3.2.8.6**. All documents must display this version in their header.
...
- [ ] Version number is 0.3.2.8.6 in header
