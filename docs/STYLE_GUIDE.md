...
> **Version:** 0.9.0.2 | **Last Updated:** 2026-05-23
...
The current version is **0.9.0.2**. All documents must display this version in their header.
...
- [ ] Version number is 0.9.0.2 in header
