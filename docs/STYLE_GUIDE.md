...
> **Version:** 0.3.5.5 | **Last Updated:** 2026-02-21
...
The current version is **0.3.5.5**. All documents must display this version in their header.
...
Before submitting documentation changes:
 ...
 - [ ] Version number is 0.3.5.5 in header
