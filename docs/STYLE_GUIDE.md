...
> **Version:** 0.4.4.1 | **Last Updated:** 2026-03-02
...
The current version is **0.4.4.1**. All documents must display this version in their header.
...
- [ ] Version number is 0.4.4.1 in header
