...
> **Version:** 0.3.6 | **Last Updated:** 2026-02-24
...
The current version is **0.3.6**. All documents must display this version in their header.
...
Before submitting documentation changes:
 ...
 - [ ] Version number is 0.3.6 in header
