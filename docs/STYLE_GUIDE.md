...
> **Version:** 0.5.3 | **Last Updated:** 2026-04-28
...
The current version is **0.5.3**. All documents must display this version in their header.
...
- [ ] Version number is 0.5.3 in header
