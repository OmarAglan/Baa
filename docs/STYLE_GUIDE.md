...
> **Version:** 0.5.5 | **Last Updated:** 2026-05-05
...
The current version is **0.5.5**. All documents must display this version in their header.
...
- [ ] Version number is 0.5.5 in header
