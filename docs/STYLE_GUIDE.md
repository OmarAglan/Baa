...
> **Version:** 0.9.1.4 | **Last Updated:** 2026-05-29
...
The current version is **0.9.1.4**. All documents must display this version in their header.
...
- [ ] Version number is 0.9.1.4 in header
