...
> **Version:** 0.3.4.5 | **Last Updated:** 2026-02-19
...
The current version is **0.3.4.5**. All documents must display this version in their header.
...
- [ ] Version number is 0.3.4.5 in header
