...
> **Version:** 0.3.2.7.1 | **Last Updated:** 2026-02-16
...
The current version is **0.3.2.7.1**. All documents must display this version in their header.
...
- [ ] Version number is 0.3.2.7.1 in header
