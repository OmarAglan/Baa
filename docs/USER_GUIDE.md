...
> **Version:** 0.9.1.5 | [← README](../README.md) | [Language Spec →](LANGUAGE.md)
...
| `--dump-ast` | Print deterministic parser AST shape and stop after parsing. | `.\baa.exe --dump-ast main.baa` |
...
# Stage-0 bootstrap manifest gate
