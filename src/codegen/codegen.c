...
bool baa_generate_function(BaaCodeGen *gen, void *unused_function /* BaaFunction* function */)
{ // AST type removed
...
bool baa_generate_statement(BaaCodeGen *gen, void *unused_stmt /* BaaStmt* stmt */)
{ // AST type removed
    if (!gen || !unused_stmt)
    {
        return false;
...
bool baa_generate_expression(BaaCodeGen *gen, void *unused_expr /* BaaExpr* expr */)
{ // AST type removed
    if (!gen || !unused_expr)
    {
        return false;
...
bool baa_optimize_function(BaaCodeGen *gen, void *unused_function /* BaaFunction* function */)
{ // AST type removed
#ifdef LLVM_AVAILABLE
...
bool baa_generate_function_debug_info(BaaCodeGen *gen, void *unused_function /* BaaFunction* function */)
{ // AST type removed
#ifdef LLVM_AVAILABLE
