...
typedef struct Node {
    ...
    // التصريح الذي حُلَّ إليه هذا الاستخدام أثناء التحليل الدلالي.
    // المؤشر مستعار من شجرة AST نفسها، ويُستخدم لعقود أدوات المحرر الدقيقة.
    const struct Node* resolved_decl;
